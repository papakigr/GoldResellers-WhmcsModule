...
.. code-block:: bash
	...
	B) Αν η έκδοση της whmcs σας είναι μεγαλύτερη ή ίση από  7.0.0. τότε ακολουθήσε τα παρακάτω βήματα 
		1) Ανοίξτε το αρχείο whois.json που βρίσκεται στον φάκελο DomainSearchFiles στα αρχεία που έχετε κατεβάσει
		...
		το οποίο κάνατε upload.
		5) Ανεβάστε το  αρχείο whois.json στον server ,στο μονοπάτι /resources/domains/ όπως αναφέρει η whmcs εδώ http://docs.whmcs.com/WHOIS_Servers
