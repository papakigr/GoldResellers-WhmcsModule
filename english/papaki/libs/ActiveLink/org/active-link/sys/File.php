...
class File {
    ...
    public  function __construct($filename = "", $fileOpenMode = "rb") {
		...
		$this->fileOpenModeRead = "rb";
		$this->fileOpenModeReadWrite = "rb+";
		$this->fileOpenModeWrite = "wb";
		$this->fileOpenModeWriteRead = "wb+";
		$this->fileOpenModeAppend = "ab";
		$this->fileOpenModeAppendRead = "ab+";
